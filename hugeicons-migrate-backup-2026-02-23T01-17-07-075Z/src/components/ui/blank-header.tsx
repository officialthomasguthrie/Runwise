  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={cn(
            "absolute top-16 left-0 right-0 bg-stone-50 dark:bg-background border-b border-stone-200 dark:border-white/10 overflow-hidden transition-all duration-300 ease-in-out transform",
            isMobileMenuOpen 
            ...
            <div className="w-full max-w-2xl space-y-1.5">
              ...
              <div className="relative" ref={searchRef}>
                ...
                {showDropdown && (showHistory || showResults || showNoResults) && (
                  <div className="absolute top-full left-0 right-0 mt-2 z-[100] rounded-lg border border-stone-200 dark:border-white/10 bg-stone-50 dark:bg-black shadow-lg max-h-96 overflow-y-auto">
                    {/* Search Results */}
                    {showResults && (
                      <div className="p-2">
