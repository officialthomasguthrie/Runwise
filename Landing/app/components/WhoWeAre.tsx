  ...
  return (
    ...
    >
      <motion.div
        ...
        viewport={{ once: true }}
        className="border border-[#ffffff1a] bg-[#0d0d0d] text-[#ffffffB3] h-[32.8px] w-fit rounded-lg flex items-center px-[13px] text-sm font-light text-center leading-[1.2em]"
      >
        Who We Are
      </motion.div>
      ...
      <div
        ...
        style={{
          background: "radial-gradient(28% 25%,#512feb26 0%,#ababab00 100%)",
        }}
      >
