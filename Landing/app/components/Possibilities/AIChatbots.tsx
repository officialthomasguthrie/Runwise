...
export const AIChatbots = () => {
  return (
    <div className="border border-[#ffffff1a] bg-[#ffffff0f] rounded-[10px] py-5 px-5 md:px-7.5 relative overflow-hidden flex flex-col gap-5 h-fit">
      <div className="h-[280px] w-full relative overflow-hidden rounded-lg flex items-start justify-center pt-2.5">
        <div className="pb-2.5 px-2.5 w-full mx-auto">
          <div
          ...
          >
            <div className="p-2.5 flex gap-2.5 mx-auto z-10">
              <div className="bg-[#ffffff1f] rounded-md w-7.5 h-7.5"></div>
              ...
              <div className="absolute inset-0 rounded-lg overflow-hidden">
                <div
                  ...
                  style={{
                    ...
                    animation: "spin-one 4s linear infinite",
                  }}
                />
              </div>
      ...
      <div>
        ...
        <p className="text-base -tracking-[.02em] font-normal leading-[1.4em] text-[#ffffffB3]">
          Deliver instant, accurate responses with AI-powered chatbots that
          handle support, FAQs, customer queries, and more.
        </p>
      </div>
    </div>
  );
