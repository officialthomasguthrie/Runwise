...
export const Process: React.FC = () => {
  ...
  return (
    <section className="px-6 md:px-10 pt-[110px] space-y-[65px]" id="process">
      {/* Header */}
      <motion.div
      ...
      <div className="max-w-[364px] md:max-w-[1200px] w-full mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7.5">
        <motion.div
          initial="hiddenLeft"
          whileInView="visible"
