...
export const Benefits: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Benefit Cards */}
      <div className="max-w-[1200px] w-full grid grid-cols-1 md:grid-cols-3 gap-7.5">
        {/* Cost reduction */}
        <motion.div
          className="border border-[#ffffff1a] bg-[#ffffff0f] rounded-[30px] p-7.5 relative overflow-hidden flex flex-col gap-5"
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          {/* Icon */}
          <div className="w-8 h-8 flex items-center justify-center rounded-lg bg-white/20 relative z-10">
            <img
              src={BENEFITS[0].icon}
          ...
          <div className="flex flex-col gap-2.5 relative z-10">
            <h4 className="text-[22px] font-normal leading-[1.2em] tracking-tight">
              {BENEFITS[0].title}
            </h4>

            <p className="text-base font-normal text-[#ffffffb3] leading-[1.4em]">
