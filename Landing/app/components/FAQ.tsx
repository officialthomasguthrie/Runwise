  ...
  return (
    <section className="py-20 px-6 md:px-10 overflow-hidden space-y-[65px]">
        ...
        {faqs.map((faq, index) => (
          ...
          >
            ...
            <button
              ...
              className="w-full px-5 py-4.5 flex items-center justify-between text-left cursor-pointer group"
            >
            ...
            >
              <div className="overflow-hidden">
                <p className="px-5 pb-4.5 text-[#ffffffb3] text-base leading-[1.5em]">
                  {faq.answer}
                </p>
              </div>
            </div>
      ...
      <div
        ...
        style={{
          background: "radial-gradient(21% 42%,#bd28b3ba 0%,#38363d00 100%)",
        }}
      >
        <motion.div
          initial="hidden"
        ...
        >
          ...
          {/* CTA Button */}
          <button className="border border-[#ffffff1a] bg-[#bd28b3ba] max-w-[150.44px] whitespace-nowrap w-full rounded-lg py-2.5 px-[15px] cursor-pointer overflow-hidden relative group">
