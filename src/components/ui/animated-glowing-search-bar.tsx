    ...
    <div className="relative flex items-center justify-center">
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        ...
        <div id="main" className="relative group">
          ...
          <div className="absolute h-[30px] w-[28px] overflow-hidden top-[5px] right-[5px] rounded-lg
                          before:absolute before:content-[''] before:w-[400px] before:h-[400px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-90
          ...
          <div id="filter-icon" className="absolute top-1 right-1 flex items-center justify-center z-[2] max-h-8 max-w-[28px] h-full w-full [isolation:isolate] overflow-hidden rounded-lg bg-gradient-to-b from-muted via-background to-muted border border-border">
            <svg preserveAspectRatio="none" height="20" width="20" viewBox="4.8 4.56 14.832 15.408" fill="none">
              <path d="M8.16 6.65002H15.83C16.47 6.65002 16.99 7.17002 16.99 7.81002V9.09002C16.99 9.56002 16.7 10.14 16.41 10.43L13.91 12.64C13.56 12.93 13.33 13.51 13.33 13.98V16.48C13.33 16.83 13.1 17.29 12.81 17.47L12 17.98C11.24 18.45 10.2 17.92 10.2 16.99V13.91C10.2 13.5 9.97 12.98 9.73 12.69L7.52 10.36C7.23 10.08 7 9.55002 7 9.20002V7.87002C7 7.17002 7.52 6.65002 8.16 6.65002Z" stroke="currentColor" strokeWidth="1" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" className="text-muted-foreground"></path>
            </svg>
          </div>
