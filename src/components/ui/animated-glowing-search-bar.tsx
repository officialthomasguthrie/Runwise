    ...
    <div className="relative flex items-center justify-center">
      <div id="main" className="relative group">
        <input 
          ...
          className="bg-background border border-stone-200 dark:border-white/10 w-full h-[40px] rounded-lg text-foreground px-[40px] text-sm focus:outline-none placeholder-muted-foreground" 
        />
