        ...
        <div className="w-full max-w-xs" suppressHydrationWarning={true}>
          <div className="flex flex-col gap-2" suppressHydrationWarning={true}>
            ...
            <form className="space-y-2" onSubmit={onSignUp} suppressHydrationWarning={true}>
              <div className="animate-element animate-delay-300 grid grid-cols-2 gap-2" suppressHydrationWarning={true}>
                <div suppressHydrationWarning={true}>
                  ...
                  <GlassInputWrapper>
                    <input name="firstName" type="text" placeholder="John" className="w-full bg-transparent text-xs p-1.5 rounded-lg focus:outline-none" required />
                  </GlassInputWrapper>
                </div>
                <div suppressHydrationWarning={true}>
                  <label className="text-xs font-medium text-muted-foreground">Last Name</label>
                  <GlassInputWrapper>
                    <input name="lastName" type="text" placeholder="Doe" className="w-full bg-transparent text-xs p-1.5 rounded-lg focus:outline-none" required />
                  </GlassInputWrapper>
                </div>
              </div>
              ...
              <div className="animate-element animate-delay-400" suppressHydrationWarning={true}>
                ...
                <GlassInputWrapper>
                  <input name="email" type="email" placeholder="john@example.com" className="w-full bg-transparent text-xs p-1.5 rounded-lg focus:outline-none" required />
                </GlassInputWrapper>
              </div>
              ...
              <div className="animate-element animate-delay-500" suppressHydrationWarning={true}>
                ...
                <GlassInputWrapper>
                  <div className="relative" suppressHydrationWarning={true}>
                    <input name="password" type={showPassword ? 'text' : 'password'} placeholder="Create a strong password" className="w-full bg-transparent text-xs p-1.5 pr-7 rounded-lg focus:outline-none" required />
              ...
              <div className="animate-element animate-delay-600" suppressHydrationWarning={true}>
                ...
                <GlassInputWrapper>
                  <div className="relative" suppressHydrationWarning={true}>
                    <input name="confirmPassword" type={showConfirmPassword ? 'text' : 'password'} placeholder="Confirm your password" className="w-full bg-transparent text-xs p-1.5 pr-7 rounded-lg focus:outline-none" required />
            ...
            <div className="animate-element animate-delay-1000 space-y-1" suppressHydrationWarning={true}>
              <button onClick={onGoogleSignUp} className="w-full flex items-center justify-center gap-2 border border-border rounded-lg py-1.5 hover:bg-secondary transition-colors">
                <GoogleIcon />
                <span className="text-xs">Continue with Google</span>
              </button>
              
              <button onClick={onMicrosoftSignUp} className="w-full flex items-center justify-center gap-2 border border-border rounded-lg py-1.5 hover:bg-secondary transition-colors">
                <MicrosoftIcon />
