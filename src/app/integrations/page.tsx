...
function IntegrationsPageContent() {
  ...
  const allIntegrations = [
    ...
    { id: 'all-11', name: 'Stripe', description: 'Payment processing', icon: DollarSign, slug: 'stripe', gradient: 'from-purple-500/20 to-violet-500/20', iconColor: 'text-purple-400', category: 'Payment', serviceName: 'stripe' },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {configuredIntegrations.map((integration) => {
                    ...
                    return (
                      <div
                        key={integration.id}
                        className="group relative rounded-lg border border-stone-200 bg-gradient-to-br from-stone-100 to-stone-200/60 dark:from-zinc-900/90 dark:to-zinc-900/60 dark:border-white/20 backdrop-blur-xl p-6 transition-all duration-300 text-foreground"
                      >
                        <div className="flex items-start gap-4">
                      ...
                      <div className="mt-4">
                        {integration.serviceName && isIntegrationConnected(integration.serviceName) ? (
                          ...
                          <Button
                            ...
                            className="w-full justify-center backdrop-blur-xl bg-white/60 dark:bg-white/5 border border-stone-200/50 dark:border-white/10 shadow-none hover:bg-white/70 dark:hover:bg-white/10 transition-all duration-300 active:scale-[0.98] text-foreground"
                          >
