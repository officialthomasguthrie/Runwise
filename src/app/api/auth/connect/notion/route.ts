/**
 * Notion OAuth Connect Route
 * Initiates OAuth flow for Notion integration
 */

import { NextRequest, NextResponse } from 'next/server';
import { createClient } from '@/lib/supabase-server';
import { getNotionAuthUrl, generateStateToken } from '@/lib/integrations/oauth';
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('[API /auth/connect/notion] Initiating Notion OAuth flow');
