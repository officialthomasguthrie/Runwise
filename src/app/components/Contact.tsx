          ...
          <ul className="mt-[35px] flex flex-col items-center md:items-start gap-y-2.5">
            <li className="flex items-center gap-2.5">
              ...
              <span className="text-[#ffffffb3] text-base -tracking-[.02em] leading-[1.2em] font-light hover:text-white">
                <Link href="mailto:hello@runwiseai.app" target="_blank">
                  hello@runwiseai.app
                </Link>
              </span>
            </li>
          ...
          <div className="px-2.5 w-full flex flex-col gap-y-5" onSubmit={handleSubmit}>
            <label htmlFor="name">
              ...
              <input
                ...
                name="Name"
                required
                className="bg-[#ffffff0f] border border-[#ffffff1a] h-10 rounded-[8px] p-3 text-sm font-light placeholder:text-[#ffffffb3] text-white w-full focus:outline-[#09f] outline-1 outline-transparent"
              />
            </label>
            ...
            <label htmlFor="message">
              ...
              <textarea
                ...
                name="Message"
                required
                className="bg-[#ffffff0f] border border-[#ffffff1a] min-h-[100px] rounded-[8px] p-3 text-sm font-light placeholder:text-[#ffffffb3] text-white w-full focus:outline-[#09f] outline-1 outline-transparent"
              />
            </label>
            ...
            <button 
              ...
              className="border border-[#ffffff1a] bg-[#bd28b3ba] w-full rounded-lg px-2 h-10 cursor-pointer text-center text-[15px] start-building-btn transition-all duration-300"
            >
              Submit
            </button>
          </div>
