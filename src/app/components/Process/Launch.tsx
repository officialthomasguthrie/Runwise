...
export const Launch = () => {
  return (
    <div className="border border-[#ffffff1a] bg-[#ffffff0f] rounded-[18px] py-6 px-5 md:px-7.5 relative overflow-hidden flex flex-col gap-5 h-fit">
      <div
        className="h-[200px] w-full relative overflow-hidden rounded-t-[10px] bg-[#ffffff1f] space-y-[5px]"
        style={{
      ...
      >
        ...
        <div className="flex gap-[5px] px-[3px] pb-2.5 relative h-full overflow-hidden">
          <div className="bg-[#ffffff1f] h-full rounded-t-lg px-[5px] pt-[5px] pb-[3px] flex flex-col gap-y-[5px] flex-1">
            ...
            <div className="flex items-center gap-[7px] py-[3px] px-[5px] bg-[#fff3] rounded-t-lg">
              <div className="bg-[#fff3] w-[15px] h-[15px] flex items-center justify-center rounded">
                <Image
          ...
          <div className="bg-[#ffffff1f] h-full rounded-t-lg px-[5px] pt-[5px] pb-[3px] flex flex-col gap-y-[5px] flex-1">
            ...
            <div className="flex flex-col items-center gap-[5px]">
              ...
              <div className="bg-[#ffffff8f] rounded-t-lg w-[70%] h-[3px] mx-auto overflow-hidden relative">
                {/* Animated Progress Bar */}
                <div
                  className="bg-[#512febcc] rounded-t-lg h-[3px] absolute left-0 animate-progress"
                  style={{ width: "20px" }}
                />
              </div>
            </div>
