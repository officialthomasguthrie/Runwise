...
export const Prompt = () => {
  return (
    <div className="border border-[#ffffff1a] bg-[#ffffff0f] rounded-[18px] py-6 px-5 md:px-7.5 relative overflow-hidden flex flex-col gap-5 h-fit">
      <div
        className="h-[200px] w-full relative overflow-hidden rounded-t-[10px] bg-[#ffffff1f]"
        style={{
        ...
        <div className="pb-2.5 px-2.5 w-[265px] mx-auto">
          ...
          >
            <div className="p-2.5 flex gap-2.5 mx-auto z-10">
              <div className="bg-[#ffffff1f] rounded-t-lg flex flex-col items-end gap-2.5 p-2.5 w-full flex-1">
              ...
              <div className="bg-[#ffffff1f] border border-[#ffffff1a] rounded-t-md w-7.5 h-7.5"></div>
            </div>
          ...
          <div className="absolute left-1/2 -translate-x-1/2 bottom-0 z-40 w-[83%]">
            <div className="w-[90%] mx-auto relative">
              ...
              {/* Search Bar */}
              <div className="relative bg-[#ffffff0d] rounded-t-lg p-0.5">
                <div className="bg-[#313131] rounded-t-lg py-2.5 px-5 flex items-center justify-between w-full">
                  <p className="text-[#fffc] text-sm font-light">
                    Ask me something..
                  </p>

                  <div className="bg-[#ffffff1f] rounded-t w-[25px] h-[25px] flex items-center justify-center">
                    <Image
